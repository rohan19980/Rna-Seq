...
#SBATCH --output=/data/users/adhali/output/output_kallisto_%j.o
#SBATCH --error=/data/users/adhali/error/error_kallisto_%j.e
...
ln -s $HOME_DIR/StringTie/meta-assembly.gtf .
